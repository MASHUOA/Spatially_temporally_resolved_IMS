...
- [1. Initialization settings and
  ...
  - [1.1 Global functions](#11-global-functions)
  - [1.2 Package Setup](#12-package-setup)
  - [1.3 Raw data, processed spectrum, and
    result](#13-raw-data-processed-spectrum-and-result)
...
``` r
tsnefolder<-"V:/Bioinformatics/FIt-SNE/"
...
## 1.3 Raw data, processed spectrum, and result

Raw data link for steps 3 and 4: [*Project on
metaspace*](https://metaspace2020.eu/api_auth/review?prj=54e09ade-8cb1-11ee-adab-831686c45448&token=pwemUgFOuNiB)

Result link for step 5 and later:
[](https://www.dropbox.com/t/5zOCpQDGbzaevoZy)

Result link for step 5 and later also can be retrieved from the GitHub
repo by using the R code below:
...
large_files_dir <- "~/Manuscript/test/large_files/"
...
#imging data of full m/z features in all runs
